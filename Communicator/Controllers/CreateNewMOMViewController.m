...
- (IBAction)sendNewMom:(id)sender
{
        ...
        if (subjectTextField!=nil)
        {
            ...
            {
                if (attendiesTextview!=nil)
                {
                    if (keyPointstextView!=nil)
                    {
                ...
                NSArray* keys=[NSArray arrayWithObjects:@"subject",@"createdDate",@"attendee",@"keyPoints",@"userFrom",@"userTo",@"userFeedback",@"submittedDateTime",nil];
                // NSArray* values=[NSArray arrayWithObjects:feedObj.soNumber,feedObj.userFrom,feedObj.userTo,feedObj.feedbackText,feedObj.feedbackType,feedObj.feedbackCounter+1, nil];
                        ...
                        NSArray* values=@[momObj.subject,momObj.momDate, momObj.attendee,momObj.keyPoints,[NSString stringWithFormat:@"%d",momObj.userFrom],[NSString stringWithFormat:@"%d",momObj.userTo],[NSString stringWithFormat:@"%d",momObj.userfeedback],momObj.dateTime];
                ...
                [[APIManager sharedManager] sendNewMOM:[[NSUserDefaults standardUserDefaults] valueForKey:@"flag"] Dict:dic username:[[NSUserDefaults standardUserDefaults] valueForKey:@"currentUser"] password:[[NSUserDefaults standardUserDefaults] valueForKey:@"currentPassword"]];
